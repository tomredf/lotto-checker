...
export default function Contact() {
  return (
    <section className="relative pt-12" aria-labelledby="contact-heading">
      <div className="absolute h-1/2 w-full" aria-hidden="true" />

      <div className="mx-auto max-w-7xl px-0 sm:px-0 lg:px-0">
        <div className="relative rounded-lg bg-gray-100 shadow-xl dark:bg-gray-800">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            {/* Contact information */}
            <div className="relative overflow-hidden rounded-t-lg bg-gradient-to-b from-primary-500 to-primary-600 py-10 px-6 sm:px-10 lg:rounded-l-lg lg:rounded-r-none xl:p-10">
              ...
              <p className="mt-6 max-w-3xl text-base text-primary-50">
                ...
                questions, please contact us using the contact info below or send us a message using
                the form.
              </p>
            ...
            <div className="rounded-lg py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
              ...
              >
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      className="mt-1 block w-full rounded-md border-gray-300 bg-white text-base text-gray-700 shadow-sm focus:border-orange-500 focus:ring-orange-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"
                    />
                  </div>
                </div>
                <div>
                ...
                <div className="sm:col-span-2 sm:flex sm:justify-end">
                  <button
                    type="submit"
                    className="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-primary-500 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 sm:w-auto"
                  >
                    Submit
                  </button>
                </div>
